...
@Api(name = "freesnowparkingendpoint", namespace = @ApiNamespace(ownerDomain = "and1droid.com", ownerName = "and1droid.com", packagePath = ""), description = "Liste des parking gratuits lors des déneigements")
