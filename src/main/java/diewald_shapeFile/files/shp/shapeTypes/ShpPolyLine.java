...
public class ShpPolyLine extends ShpShape {
    ...
    public String toString() {
        ...
        stringBuilder.append("  / SHAPE   \\_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _\n");
        stringBuilder.append("  |                                                    \\\n");
        stringBuilder.append("  |  <RECORD HEADER>\n");
        stringBuilder.append("  |    SHP_record_number       = " + SHP_record_number + "\n");
        stringBuilder.append("  |\n");
        stringBuilder.append("  |  <RECORD CONTENT>\n");
        stringBuilder.append("  |    shape_type              = " + shape_type + " (" + shape_type.ID() + ")\n");
        stringBuilder.append("  |    SHP_num_parts           = " + SHP_num_parts + "\n");
        stringBuilder.append("  |    SHP_num_points          = " + SHP_num_points + "\n");
        // for(int i = 0; i < SHP_num_parts; i++){
        // System.out.printf(Locale.ENGLISH, "  |     part_idx[%d] = %d\n", i, SHP_parts[i] );
        // }
        //
        stringBuilder.append("  \\_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ /\n");
