...
public class CoordinateConverterTest {
    ...
    public void convertDatas() throws IOException {
        ...
        add10Coordinate(coords);
        add10Coordinate(coords);
        List<String> convert = CoordinateConverter.callConvertService(coords, new Gson(), 0);
    ...
    /*@Test
    public void convertPointsToCoords() throws IOException {
        InputStream resourceAsStream = getClass().getResourceAsStream("/ilot/ilot.json");
        JsonReader jsonReader = new JsonReader(new InputStreamReader(resourceAsStream, "UTF-8"));
        Gson gson = new Gson();
        Ilot ilot = gson.fromJson(jsonReader, Ilot.class);
        List<String> convertToShapes = CoordinateConverter.convertToShapes(ilot.getPoints());
        System.out.println(gson.toJson(convertToShapes));
    }*/
}
